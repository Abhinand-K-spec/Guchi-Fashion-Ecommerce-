...
const downloadSalesReportExcel = catchAsync(async (req, res, next) => {
...
const getSalesReport = catchAsync(async (req, res, next) => {
  const { period, range, startDate, endDate } = req.query;
...
const downloadSalesReport = catchAsync(async (req, res, next) => {
  const { period, range, startDate, endDate } = req.query;
